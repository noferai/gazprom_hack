(function(b) {
  ...
  b.extend(!0, f.defaults, {
    dom: "<'columns'<'column is-8'B><'column is-4'f>><'columns'<'column is-12 table-container'tr>><'columns'<'column is-5'i><'column is-7'p>>",
    renderer: "bulma"
  });
  b.extend(f.ext.classes, {
    sWrapper: "dataTables_wrapper dt-bulma",
    sFilter:"control has-icons-left has-icons-right search-table",
    sFilterInput: "input",
    sLength: "select",
    sLengthSelect: "input",
