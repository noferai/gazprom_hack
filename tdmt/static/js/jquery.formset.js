...
;(function ($) {
    $.fn.formset = function (opts) {
        ...
        if ($$.length) {
            ...
            if ($$.attr('tagName') == 'TR') {
                ...
                $$.filter(':last').after('<button class="' + options.addCssClass + '" href="javascript:void(0)"><span class="icon is-small"><i class="fas fa-plus"></i></span><small>' + options.addText + '</small></button>');
    ...
    $.fn.formset.defaults = {
        ...
        addCssClass: 'button add is-pulled-right',          // CSS class applied to the add link
        deleteCssClass: 'display-none',    // CSS class applied to the delete link
